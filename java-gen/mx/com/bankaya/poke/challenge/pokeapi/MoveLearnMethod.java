...
public class MoveLearnMethod {
    ...
    public MoveLearnMethod withName(String name) {
        this.name = name;
        return this;
    }
    ...
    public MoveLearnMethod withUrl(String url) {
        this.url = url;
        return this;
    }
    ...
    public MoveLearnMethod withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
