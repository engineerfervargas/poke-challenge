...
public class Silver {
    ...
    public Silver withBackDefault(String backDefault) {
        this.backDefault = backDefault;
        return this;
    }
    ...
    public Silver withBackShiny(String backShiny) {
        this.backShiny = backShiny;
        return this;
    }
    ...
    public Silver withFrontDefault(String frontDefault) {
        this.frontDefault = frontDefault;
        return this;
    }
    ...
    public Silver withFrontShiny(String frontShiny) {
        this.frontShiny = frontShiny;
        return this;
    }
    ...
    public Silver withFrontTransparent(String frontTransparent) {
        this.frontTransparent = frontTransparent;
        return this;
    }
    ...
    public Silver withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof Silver) == false) {
            return false;
        }
        Silver rhs = ((Silver) other);
